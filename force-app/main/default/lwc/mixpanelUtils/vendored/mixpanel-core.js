...
Autocapture.prototype._initScrollDepthTracking = function () {
  ...
  var updateScrollDepth = function () {
    ...
    var scrollViewHeight =
      Math.max(document$1.documentElement.clientHeight, win.innerHeight || 0) +
      win.scrollY;
...
var create_mplib = function (token, config, name) {
  var instance,
    target =
      name === PRIMARY_INSTANCE_NAME ? mixpanel_master : mixpanel_master[name];
...
MixpanelLib.prototype._send_request = function (url, data, options, callback) {
  ...
  var use_sendBeacon =
    sendBeacon && use_post && options.transport.toLowerCase() === "sendbeacon";
...
function loadThrowError(src, _onload) {
  throw new Error(
    "This build of Mixpanel only includes core SDK functionality, could not load " +
      src
  );
}
...
export var mixpanel = init_as_module(loadThrowError);
